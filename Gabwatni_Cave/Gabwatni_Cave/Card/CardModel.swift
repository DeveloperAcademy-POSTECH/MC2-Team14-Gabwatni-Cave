...
class CardViewModel2: ObservableObject {
    ...
    let CardData : [String : Array<String>] = [
        ...
        "salamander" : ["동굴 도룡뇽","퇴화한 눈이 색소가 없는 피부 밑에 파묻힌게 특징|자신의 신체를 분해하여 양분을 공급받아 불로불사할 수 있음"],
        "cavecoral" : ["동굴 산호","바다의 산호와 모양이 비슷해 이런 이름이 붙음|동굴 팝콘이라고도 불리며 방해석과 아라고나이트로 이루어짐"],
        "stalactite" : ["종유석","천정에서 지하수가 떨어질 때 지하수의 탄산칼슘 성분이 천장에 맺혀|시간이 흐룰수록 바닥쪽으로 성장해 가는 고드름 모양의 석회 기둥"],
        "water" : ["동굴 물", "동굴에 특별한 물"]
    ]
