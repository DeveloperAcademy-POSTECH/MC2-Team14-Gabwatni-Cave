   ...
   // @Binding var flow : Int
    var body: some View {
        ZStack{
            ...
            newTextBox3(StrArr: ["\"지도??\"","\"이게 뭐지?\"","(지도 사진을 스와이프하여 지도를 확인해 보세요)","(세계 각지에 흩어진 보물의 조각들을 모으면 원하는 소원을 들어주겠다...)","\"뭐야 장난치는 것도 아니고 이런게 왜 내 옷장에 있지?\"","\"아 참..\"","\"생각해 보니까 저번에 할아버지의 할아버지의 할아버지가 보물을 찾으러 갔다가\"","\"못 돌아오셨다는 소리를 들은 것 같기도 하고...\"","\"근데 그게 사실이었다고?!\"","\"말도 안돼..\"","\"내가 진실을 밝혀내겠어 !!!!\"","(최병호의 말이 끝나기가 무섭게 최병호는 지도 속으로 빨려들어갔다)","시작합니다\n가봤냐? - 동굴편"," "],charArr: [" "," "," "," "," "," "," "," "," "," "," "," "," "])
